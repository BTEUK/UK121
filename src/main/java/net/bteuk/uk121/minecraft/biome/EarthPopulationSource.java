...
public class EarthPopulationSource extends BiomeSource {
    ...
    public static Codec<EarthPopulationSource> CODEC;
     ...
     */
    public EarthPopulationSource(Registry<Biome> biomeRegistry, int biomeSize, long seed) {
        ...
        CODEC = RecordCodecBuilder.create((instance) ->
                instance.group(RegistryLookupCodec.of(Registry.BIOME_KEY).forGetter((biomeSource) ->
                        ...
                        biomeSource.seed)).apply(instance, instance.stable(EarthPopulationSource::new)));
    }

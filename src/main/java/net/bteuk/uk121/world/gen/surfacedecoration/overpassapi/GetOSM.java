...
public class GetOSM extends DefaultHandler
{
	...
	private static ArrayList<Way> ways = new ArrayList<Way>();
	private static ArrayList<Node> nds = new ArrayList<Node>();

	private static int iWays = 0;
	...
	public static ArrayList<Object> entry(String URL)
	{
	//	current = new Current();
		try
		{
	...
	{		
		try
		{
			...
			xmlReader.setContentHandler((ContentHandler) new GetOSM(51.43644372195998, 0.3816638279204503, 51.4381892499097, 0.38544040834318255));
			String URL = "https://overpass-api.de/api/interpreter?data=%28%0A%20%20nwr%5Bbuilding%5D%28" +bbox.minX()+"%2C"+bbox.minZ()+"%2C" +
					bbox.maxX() +"%2C"+bbox.maxZ()+"%29%3B%0A%20%20nwr%5Bhighway%5D%28" +bbox.minX()+"%2C"+bbox.minZ()+"%2C" +
					bbox.maxX() +"%2C"+bbox.maxZ()+ "%29%3B%0A%29%3B%0Aout%20geom%3B";
